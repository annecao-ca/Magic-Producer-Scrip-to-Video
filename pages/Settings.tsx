  ...
  return (
    <div className="max-w-4xl mx-auto pb-20 animate-fadeIn">
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-8 shadow-lg mb-8">
         <h2 className="text-xl font-bold text-white mb-6 flex items-center">
            <Database className="mr-2 text-green-400" /> Database Management (Local)
         </h2>
         
         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-black/40 border border-gray-800 rounded-xl p-5">
               <h3 className="font-bold text-white mb-2 flex items-center">
                  <Download size={18} className="mr-2 text-brand-400" /> Backup Database
               </h3>
               <p className="text-xs text-gray-400 mb-4">
                  Download your entire database (projects, characters, settings) as a <code>.dmp</code> file.
               </p>
               <button 
            ...
            <div className="bg-black/40 border border-gray-800 rounded-xl p-5">
               <h3 className="font-bold text-white mb-2 flex items-center">
                  <Upload size={18} className="mr-2 text-blue-400" /> Restore Database
               </h3>
               <p className="text-xs text-gray-400 mb-4">
                  Restore from a backup file. <span className="text-red-400">Warning: This will overwrite current data.</span>
               </p>
               <button 
